            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="<?=base_url();?>posts/updatePost/<?=$post['id']?>" class="register-form" id="login-form" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" id="" cols="35" placeholder="Post body" rows="10"><?=$post['body'];?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select name="catagory">
                                    <option value="1">Post Catagory</option>
